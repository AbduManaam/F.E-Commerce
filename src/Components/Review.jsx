...
const Review = () => {
  return (
    <section className="padd-container py-37 xl:py-28 bg-white flexCenter">
      
       <div className='pb-10px flexCenter flex-col text-center'>
        <h3>WHAT
          <span className='font-light text-solidTwo text-center'> PEOPLE SAYS</span>
          <p className='undefined max-w-lg mt-2 text-center'>Discover fresh foods that delight your taste, nourish your body, and bring joy to every meal.</p>
        </h3>
                         {/* MAIN DIV */}
        
        <div className="flex flex-wrap items-center justify-center gap-8 py-15"> 
